...
func (r clusterReconciler) reconcileDeploymentZones(ctx *context.ClusterContext) (bool, error) {
	...
	if readyNotReported > 0 {
		conditions.MarkFalse(ctx.VSphereCluster, infrav1.FailureDomainsAvailableCondition, infrav1.FailureDomainsNotReadyReason, clusterv1.ConditionSeverityInfo, "waiting for failure domains to report ready status")
		return false, nil
	}
